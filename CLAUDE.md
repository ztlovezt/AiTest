...
**当前阶段**：Phase 1（精准测试落地）—— Week 4 / 8（风险预测 + 最小回归集 MVP）

| 周次 | 主题 | 状态 |
|------|------|------|
| Week 1 | 基础架构（13 个 Python 模块 + 6 张 MySQL 表 + Neo4j 容器化） | ✅ 已完成（commit 历史） |
...
| Week 4 | 风险预测 + 最小回归集 MVP（risk_predictor 211行 91%覆盖率 / regression_selector 155行 95%覆盖率 / 87新增测试 / 366累计通过 / demo减少率85%） | ✅ 已完成 |
| Week 5-8 | 前端 / CI Hook / DORA / 试点上线 | ⏳ 待启动 |
