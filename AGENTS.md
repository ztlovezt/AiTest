...
TestHub is an AI-driven test management platform built with Django 6.0.2 (backend) + Vue 3 (frontend). It provides test case management, API testing, UI automation testing, AI-powered requirement analysis, and test case generation capabilities.
