...
class TestPlanAdmin(StandardAdminMixin, admin.ModelAdmin):
...
class TestRunAdmin(StandardAdminMixin, admin.ModelAdmin):
...
class TestRunCaseAdmin(StandardAdminMixin, admin.ModelAdmin):
...
class TestRunCaseHistoryAdmin(StandardAdminMixin, admin.ModelAdmin):
