  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import("@/views/knowledge-base/KnowledgeBaseDetail.vue"),
      },
      {
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () =>
              import("@/views/unified-projects/UnifiedProjectDetail.vue"),
          },
          {
            path: "ai-model",
            name: "ConfigAIModel",
          ...
          },
          {
            ...
            component: () =>
              import("@/views/configuration/KnowledgeBaseConfig.vue"),
          },
          {
            path: "ui-env",
            name: "ConfigUIEnv",
  ...
  // APP自动化测试路由
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import("@/views/app-automation/devices/RealDeviceManagement.vue"),
      },
      {
        path: "workbench/:id",
        name: "AppRemoteWorkbench",
        component: () =>
          import("@/views/app-automation/devices/RemoteWorkbench.vue"),
        meta: { requiresAuth: true },
      },
      {
        path: "packages",
