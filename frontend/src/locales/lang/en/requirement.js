export default {
  requirementAnalysis: {
    ...
    searchQueryPlaceholder: 'Enter requirement content to search',
    searchResults: 'Search Results',
    sourceDocument: 'Source Document',
    noSearchResults: 'Please search knowledge base first',
    generateFromKnowledge: 'Generate Test Cases from Results',
    knowledgeBaseRequirement: 'Knowledge Base Requirement Search',
    searching: 'Searching...',
    ...
    axureUrlPlaceholder: 'Please enter Axure prototype online address, e.g.: https://example.axure.com',
    confirmParse: 'Parse',
    parsing: 'Parsing...',
    parseSuccess: 'Parse successful',
    parseFailed: 'Parse failed',
    pleaseEnterAxureUrl: 'Please enter Axure URL',
    noAxureContent: 'No Axure content parsed',
    axureRequirement: 'Axure Prototype Requirement',
    useAiRefine: 'Use AI to structure and organize requirement content',
    contentType: 'Content Type',
    fullContent: 'Full Content',
    incrementalContent: 'Incremental Content',
    flowchartContent: 'Flowchart',
    noIncrementalContent: 'No incremental content',
    noFlowchartContent: 'No flowchart detected',
    sourceView: 'Source',
    previewView: 'Preview',
    editView: 'Edit',
    editContentPlaceholder: 'Edit requirement content here...',
    copyIncremental: 'Copy Incremental',
    copyIncrementalSuccess: 'Incremental content copied to clipboard',
    copyIncrementalFailed: 'Copy failed',
    parseResult: 'Parse Result',
    characters: '{count} characters',
    generateFromAxure: 'Generate from Axure',
    ...
    searchResults: 'Search Results',
    sourceDocument: 'Source Document',
    noSearchResults: 'Please perform a knowledge base search first',
    generateFromKnowledge: 'Generate Test Cases from Search Results',
    knowledgeBaseRequirement: 'Knowledge Base Requirement Search',
    searching: 'Searching...',
    ...
    axureTitle: '🎨 Axure Parsing',
    axureComingSoon: 'Coming Soon',
    axureDescription: 'Support automatic requirement parsing from Axure prototype pages',
