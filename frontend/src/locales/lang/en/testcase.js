export default {
  testcase: {
    ...
    importDialogTitle: 'Import Cases',
    importRecordsTitle: 'Import Records',
    importAlert: 'Please download the template first, fill it in according to the template format, and then upload',
    importProject: 'Project',
    importFile: 'Case File',
    selectFile: 'Select File',
    excelOnly: 'Only Excel files are allowed',
    downloadTemplate: 'Download Template',
    startImport: 'Start Import',
    importStatus: 'Status',
    importProgress: 'Progress',
    importResultStats: 'Result Stats',
    success: 'Success',
    failed: 'Failed',
    duplicate: 'Duplicate',
    ...
    importErrorDetail: 'Import Error Details',
    excelRow: 'Excel Row',
