...
export default {
  ...
  interface: {
    ...
    extractVariablesConfig: {
      ...
      defaultValue: '默认值',
      example: '示例',
      noExtractors: '暂无变量提取规则',
      help: '使用说明',
      helpJsonPathTitle: 'JSONPath 提取',
      helpJsonPathDesc: '使用 JSONPath 表达式从 JSON 响应中提取数据：',
      helpJsonPathExample1: '提取 data 对象中的 token 字段',
      helpJsonPathExample2: '提取 items 数组第一个元素的 id 字段',
      helpJsonPathExample3: '提取 users 数组中所有元素的 name 字段',
      helpRegexTitle: '正则表达式提取',
      helpRegexDesc: '使用正则表达式从响应文本中提取数据：',
      helpRegexExample1: '提取 JSON 中的 token 值',
      helpRegexExample2: '提取 URL 参数中的数字',
      helpUsageTitle: '使用示例',
      helpUsageDesc: "在后续请求中使用提取的变量，使用 {'{{变量名}}'} 格式：",
      ...
      helpWorkflowTitle: '工作流示例',
      helpWorkflowDesc: '典型的变量提取和使用流程：',
      helpWorkflowStep1: "登录接口提取 token：$.data.token → 保存为 {'{{token}}'}",
      ...
      placeholderJsonPath: '请输入JSONPath表达式，如 $.data.token',
      placeholderRegex: '请输入正则表达式，如 "token":"([^"]+)"',
      placeholderHeaderName: '请输入Header名称',
      placeholderAutoExtract: '自动提取状态码'
    },
    // WebSocket
    messageType: '选择消息类型',
  ...
  automation: {
    ...
    editAssertions: '编辑断言',
    configure: '配置',
    skipConditionConfigured: '已配置',
    skipConditionNotConfigured: '未配置',
    yes: '是',
    extractorCount: '{n} 个',
    remove: '移除',
    ...
    suiteSubmitted: '测试套件已提交执行',
    executionInProgress: '正在执行，请稍候...',
    pleaseWait: '测试套件正在后台执行中，请稍候...',
    executing: '执行中',
    executingMessage: '测试套件正在执行中，请稍候...',
    resultPassed: '通过',
    resultFailed: '失败',
    assertionHint: '套件断言为空时，将使用接口定义中的断言规则',
    clearAssertions: '清空断言',
    syncFromApi: '同步接口数据',
    syncSuccess: '同步成功',
    syncFailed: '同步失败',
    ...
    variableExtractors: '变量提取',
    configureAssertion: '配置断言',
    configureRequest: '请求配置',
    skipCondition: '跳过条件',
    skipConditionPlaceholder: '请输入跳过条件表达式，例如：variables.get("skip_flag") == True',
    skipConditionHelp: '使用Python表达式，当条件为True时跳过该请求执行。示例：variables.get("env") == "dev" 或 variables.get("skip_flag") == True 或 variables.get("count", 0) > 10',
    ...
    expectedStatusCode: '期望状态码',
    expectedValue: '期望值',
    expectedResponseTime: '期望响应时间(ms)',
    expectedContainsText: '期望包含的文本',
    expectedHeaderValue: '期望Header值',
    expectedEqualsValue: '期望完全匹配值',
  ...
  messages: {
    ...
    warning: {
      ...
      executionCompleted: '测试执行已完成'
    },
    info: {
      assertionsCleared: '断言已清空',
  ...
  response: {
    ...
    jsonPathPlaceholder: 'JSONPath查询，例如：$.data.users[0].name',
    jsonPathResult: 'JSONPath查询结果',
    jsonPathError: 'JSONPath表达式无效或查询失败',
    query: '查询',
    jsonPathHelp: '查看JSONPath语法文档',
    assertions: '断言',
    passed: '通过',
    failed: '失败',
    unnamed: '未命名断言',
  ...
  importExport: {
    ...
    file: '文件',
    curlCommand: 'cURL 命令',
    curlPlaceholder: '粘贴 cURL 命令，支持多条（每行一条）',
    dragOrClick: '拖拽文件到此处，或点击上传',
    targetProject: '目标项目',
    selectProject: '请选择目标项目',
    selectProjectFirst: '请先选择一个项目',
    selectFile: '请选择文件',
    enterCurl: '请输入 cURL 命令',
    preview: '解析预览',
    back: '返回',
    confirmImport: '确认导入 ({count} 个)',
    cancel: '取消',
    done: '完成',
    totalApis: '共 {count} 个接口',
    selectAtLeastOne: '请至少选择一个接口',
    parseFailed: '解析失败',
    importSuccess: '导入成功',
    importFailed: '导入失败',
    exportSuccess: '导出成功',
  ...
  extractor: {
    ...
    defaultValue: '默认值',
    help: '使用说明',
    helpJsonPathDesc: '从响应体中提取数据',
    helpJsonPath1: '提取token字段',
    helpJsonPath2: '提取数组第一个元素的id',
    helpJsonPath3: '提取所有用户的name',
    helpRegexDesc: '用正则表达式匹配响应内容',
    helpRegex1: '提取token值',
    helpRegex2: '提取userId参数',
    helpUsageTitle: '使用示例',
  },
  ...
  parameterized: {
    ...
    uploadSuccess: '上传成功',
    uploadFailed: '上传失败',
    fillRequired: '请填写名称、列名和数据',
    createSuccess: '创建成功',
    createFailed: '创建失败',
    executeSuccess: '执行完成',
    executeFailed: '执行失败',
    confirmDelete: '确认删除该数据集？',
    deleteSuccess: '删除成功',
  }
}
