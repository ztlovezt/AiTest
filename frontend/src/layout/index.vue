  ...
  <div class="layout">
    <el-container>
      ...
      <el-container>
        ...
        <el-header
          height="60px"
          :class="{ 'header-full': currentModule === 'meta-projects' }"
        >
          <div class="header-content">
            <div class="header-left">
              <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item v-if="showProjectManagement">{{
                  $t("menu.projectManagementCenter")
                }}</el-breadcrumb-item>
            ...
            <div class="header-right">
              ...
              <span
                class="icon-button"
                :title="
                  appStore.theme === 'hoppscotch-light'
                    ? $t('nav.themeDark')
                    : $t('nav.themeLight')
                "
                @click="toggleTheme"
...
const breadcrumbTitle = computed(() => {
  ...
  if (path.match(/^\/configuration\/meta-projects\/[^/]+$/)) {
    ...
    const projectName = nameStr
      ...
      : sessionStorage.getItem("metaProjectName");
